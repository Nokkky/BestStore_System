...
router.get('/products_sales', (req, res, next) => {
...
router.get('/products_profit', (req, res, next) => {
...
router.get('/top_product', (req, res, next) => {
  let sql = 'SELECT product_name,sum(quantity) as sum_quantity FROM transactions,product ' +
    'WHERE transactions.product_id=product.product_id ' +
    'GROUP BY transactions.product_id ' +
...
router.get('/region_sales', (req, res,next) => {
...
router.get('/product_business/:pid', (req, res, next) => {
